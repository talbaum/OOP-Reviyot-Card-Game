...
public:
	...
	int cyclicOrder(vector<Player*> players);
};
...
public:
	...
	PlayerType1(const Player &player);
...
public:
	PlayerType2();
	PlayerType2(const Player &player);
...
public:
	PlayerType3();
	PlayerType3(const Player &player);
...
public:
	PlayerType4();
	PlayerType4(const Player &player);
